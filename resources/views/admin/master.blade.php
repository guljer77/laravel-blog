        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo">
                <a href="{{ route('dashboard') }}" class="app-brand-link">
                    <span class="app-brand-text demo menu-text fw-bold ms-2 text-uppercase">Hunters</span>
                </a>
            ...
            <ul class="menu-inner py-1">
                ...
                <!-- Components -->
                <li class="menu-header small text-uppercase"><span class="menu-header-text">Tag</span></li>
                <!-- Cards -->
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon fa-solid fa-house"></i>
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="{{ route('all-tag') }}" class="menu-link">
                                <div data-i18n="Account">All Tag</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{ route('add-tag') }}" class="menu-link">
                                <div data-i18n="Notifications">Add Tag</div>
                            </a>
                        </li>
                    </ul>
                </li>
